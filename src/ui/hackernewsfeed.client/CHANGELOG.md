...
- Create Angular project with ng: `ng new hackernewsfeed.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`hackernewsfeed.client.esproj`).
